...
temp = new_BS(y,s=1,e=T, N = N)  ## structure used to find potential change points
Dval = temp$Dval ##  values  of statistic at potential change points
p =  parent(temp)###  tree structure generated by BS
...
##  An example
tau =  tau_grid[16]
S = sort(new_BS_threshold(temp,tau,p))
